<?php /*correspond à references/equipement public */
try
{
...
$req = $bdd->query('SELECT titre, url, imagepresentation FROM ref WHERE categorie="equipement public"') or die(print_r($bdd->errorInfo()));
