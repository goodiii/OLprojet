...
$req = $bdd->prepare('INSERT INTO ref(titre, url, categorie, imagepresentation, textpresentation, image1, commentaire1, image2, commentaire2, image3, commentaire3, image4, commentaire4, image5, commentaire5) VALUES(:titre, :url, :categorie, :imagepresentation, :textpresentation, :image1, :commentaire1, :image2, :commentaire2, :image3, :commentaire3, :image4, :commentaire4, :image5, :commentaire5)');
if( $req->execute(array(
	...
	{
echo '</br> La référence a été intégrée dans la base de données </br>'; 
	}
...
{
echo '<p> La page a bien ete créée. </p><a href="page/'.$url.'.php" style="color:white"><p>Voir la page créée pour la reference: '.$titre.' </p></a><a href="navolcms.php" style="color:white"><p>Retour au menu principal</p></a>'; 
}

else
{
echo '<p> La page n a pas pu etre créée</p></br><a href="navolcms.php" style="color:white"><p>Retour au menu principal</p></a>';
}
