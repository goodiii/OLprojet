...
<body id="back">
	<div class="container">
		<form style="color:white" enctype="multipart/form-data" action='CreationProjet.php' method='post'>
			<fieldset>
				<legend>Nouveau projet à mettre en ligne</legend>
				<ul>
					...
					<li>Image de présentation du projet : </li>
						<input type='file' name='imagepresentation' id='imagepresentation'></input>
					<li>Synthèse du projet (20 lignes max.) :</li>
			...
			<fieldset>
				<legend>Valider la mise en ligne du projet</legend>
