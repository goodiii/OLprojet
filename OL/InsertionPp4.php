<?php /*correspond à projets/equipement public */
try
{
...
$req = $bdd->query('SELECT titre, url, imagepresentation FROM projets WHERE categorie="equipement public"') or die(print_r($bdd->errorInfo()));
